...
export type { MangoCachePlugin } from './mango-cache-plugin.interface'
...
export type { MangoPluginOptions } from './mango-plugin-options.interface'
export type { IMangoPlugin } from './mango-plugin.interface'
